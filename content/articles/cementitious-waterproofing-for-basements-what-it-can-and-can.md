---
title: 'Cementitious Waterproofing for Basements: What It Can and Cannot Do'
description: Basement waterproofing is a critical concern for many property owners, and cementitious waterproofing often comes up in discussions. This method involves...
date: '2026-05-25T11:51:02+03:00'
lastmod: '2026-05-25T11:51:02+03:00'
draft: false
...
| Feature             | Cementitious Waterproofing (General)                               | Tanking Slurry (Specific Type)                                 |
| :------------------ | :----------------------------------------------------------------- | :------------------------------------------------------------- |
| **Formulation**     | Cement, sand, active chemicals; sometimes with polymers for flexibility. | Cement, sand, higher concentration of crystalline-forming agents, specific additives. |
| **Primary Function**| Damp-proofing, moisture resistance, general waterproofing.          | Resists significant hydrostatic pressure, forms an impermeable barrier. |
| **Permeability**    | Usually breathable, allows some vapor transfer.                     | Less breathable, designed to block all liquid water and resist pressure. |
| **Application**     | Brush, roller, spray; typically 1-2 coats.                         | Brush; often multiple, thicker coats for optimal performance.   |
| **Pressure Resist.**| Moderate resistance to dampness and light moisture.                | High resistance to sustained water pressure.                   |
| **Cost**            | Can be less expensive for basic formulations.                      | Generally higher due to specialized formulation and performance. |
| **Use Case Example**| Minor wall dampness, preventing condensation on interior walls.     | Basements with high water tables, active leaks from foundation. |
